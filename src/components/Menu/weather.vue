<template>
    <div class="weather">
        ...
        <div class="icon thunder-storm" v-if="weather.weather[0].main == 'Thunderstorm'">
            <div class="cloud"></div>
            <div class="lightning">
                <div class="bolt"></div>
                <div class="bolt"></div>
        ...
        <div class="icon flurries" v-if="weather.weather[0].main == 'Snow'">
            <div class="cloud"></div>
            <div class="snow">
                <div class="flake"></div>
                <div class="flake"></div>
        ...
        <div class="icon sunny" v-if="weather.weather[0].main == 'Clear'">
            <div class="sun">
                <div class="rays"></div>
            </div>
        </div>

        <div class="icon rainy" v-if="weather.weather[0].main == 'Shower Rain'">
            <div class="cloud"></div>
            <div class="rain"></div>
        </div>
    </div>
